...
export default class sanctumService {
  ...
  updateAdmin(data) {
    return axios.post(
      `${this.sanctumConfig.baseUrl}${
        this.sanctumConfig.updateAdminDetail
      }${data.get("id")}`,
      data,
      {
        headers: {
  ...
  //*************USERS */
   ...
   updateUser(data) {
    return axios.post(
      `${this.sanctumConfig.baseUrl}${
        this.sanctumConfig.updateUserDetail
      }${data.get("id")}`,
      data,
      {
        headers: {
  ...
  //############################## FRONTEND INTERFACE ##########################/
    ...
    // async getCountries(searchQuery = "", page = 1) {
    //   return axios.get(
    //     `${this.sanctumConfig.baseUrl}${this.sanctumConfig.getCountries}?search=${searchQuery}&page=${page}`
    //   );
    // }
